...
export class CourseService {
  ...
  constructor() {
    this._courses = [{
        ...
        type: 'Video',
        duration: 180,
        creatingDate: new Date(2017, 7, 1, 13, 30),
        description: 'Angular 2: Basics'
      }, {
        id: '2',
        type: 'Video',
        duration: 240,
        creatingDate: new Date(2017, 7, 7, 13, 30),
        description: 'Angular 2: Advanced'
      }, {
        id: '3',
        type: 'Webinar',
        duration: 120,
        creatingDate: new Date(2017, 7, 13, 13, 30),
        description: 'ReactJS: Intro'
      }, {
        id: '4',
        type: 'Webinar',
        duration: 120,
        creatingDate: new Date(2017, 7, 15, 12),
        description: 'Vue.js: Intro'
      }, {
        id: '5',
        type: 'Webinar',
        duration: 120,
        creatingDate: new Date(2017, 7, 16, 12),
